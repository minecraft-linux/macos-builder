...
if not path.isdir(CMAKE_INSTALL_FRAMEWORK_DIR):
    ...
    call(['curl', '-L', 'https://github.com/ChristopherHX/osx-packaging-scripts/releases/download/libuv10.13/libpng16.16.dylib', '--output', path.join(CMAKE_INSTALL_FRAMEWORK_DIR, 'libpng.dylib')])
