...
with open('mcpelauncher.commit', 'r') as file:
    ...
    call(['git', 'cherry-pick', '9d8f5771c4cd1e0589a2d4a510175f592aba1bdc'], cwd='mcpelauncher/mcpelauncher-client')
    call(['git', 'cherry-pick', 'd73cac9e937b4eda31d5f27e862fa220c514e5f9'], cwd='mcpelauncher/mcpelauncher-core')
